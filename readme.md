...
The detailed, code-aligned comparison is in [Features](/features).

## Start here

1. Review [Installation and Requirements](/installation).
2. Follow the [Getting Started](/getting-started) quick start.
3. Use the [Top-level Repeater Guide](/usage-guide) for the complete basic workflow.
4. Continue with the [Pro Guide](/usage-guide-pro) for nested rows, Flexible Content, relationships, filters, lightbox, and other Pro features.
